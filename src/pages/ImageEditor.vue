                        ...
                        <div
                            ...
                            :class="[
                                ...
                                gemeData.parts[gmKey].type === 'text'
                                    ...
                                    : '',
                                'overflow-hidden py-2 cursor-move select-none absolute inline-block slashed-zero tracking-wider leading-tight p-1',
                            ]"
                            :style="
                                gemeData.parts[gmKey].type === 'text'
                                    ? `color:${
...
import { gemeData, selected, addPart } from '../composables/useGemeData';
...
gemeData.backgroundImage = '/defaults/default.png';

//await asleep(10);

const pureColor = ref(selected().color);
...
onMounted(async () => {
    await insertImageFromStorage(gemeData.backgroundImage);
});
</script>
<style lang="scss">
.vc-hue-slider__bar {
